    ...
    window.addEventListener('scroll', () => {
      if (backToTop || readingProgressBar) {
        ...
        if (backToTop) {
          ...
          backToTop.querySelector('span').innerText = Math.round(scrollPercent) + percentSign;
        }
        if (readingProgressBar) {
          readingProgressBar.style.setProperty('--progress', scrollPercent.toFixed(2) + percentSign);
        }
      }
